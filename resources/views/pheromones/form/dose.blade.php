    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @endif
                {!! Form::open(['url'=>'pheromones/dose_add/'.$pheromone->id , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend style="color: green">ДОБАВЯНЕ НА ДОЗИ КЪМ {{$pheromone->name}}</legend>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12">
                                ...
                                {{ Form::label('measure', 'диспенсера') }}
                                {{ Form::radio('measure', '6,  диспенсeра/дка' ) }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-5">
                            <div class="col-lg-12">
                                ...
                                &lt;span class="latin_name"&gt;&lt;/span&gt; &lt;span class="bold"&gt;&lt;/span&gt; &lt;br/&gt;
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="col-lg-12">
