...
@section('content')
    <div class="container">
        ...
        <div class="row" style="text-align: center; color: green">
            <h4 style="color: red">АКТИВИРАНЕ ИЛИ ДЕАКТИВИРАНЕ НА ПРЗ {{$pheromone->name}}</h4>
        </div>
        <div class="col-lg-12">
            @if(count($errors)>0)
        ...
        <div class="col-lg-12" style="margin-top: 50px;">
            {!! Form::model($pheromone, ['url'=>'pheromones/deactivate_store/'.$pheromone->id , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
