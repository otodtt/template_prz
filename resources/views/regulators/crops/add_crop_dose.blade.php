...
@section('content')
    <div class="container">
        ...
        <div class="row" style="text-align: center; color: green">
            <h4>ДОБАВЯНЕ НА ДОЗИ ЗА КУЛТУРИ ОТ ПРЗ  {{$regulator->name}}</h4>
        </div>
        <div class="col-lg-12">
            @if(count($errors)>0)
            ...
            @endif
            {!! Form::open(['url'=>'regulators/crop_dose_store/'.$regulator->id.'/'.$doses[0]['id'] , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-lg-10 col-lg-offset-2">
                        <a href="{!!URL::to('/regulators/'.$regulator->id)!!}" class="btn btn-success">Назат</a>
