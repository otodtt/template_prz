...
@section('content')
    <div class="container">
        <div class="row">
            <div class="row">
                <a href="{!!URL::to('/regulators/'.$regulator['id'])!!}" >НАЗАД</a>
            </div>
            <div class="col-lg-12">
                @if(count($errors)>0)
                ...
                @endif
                {!! Form::model($regulator, ['url'=>'regulators/update/'.$regulator['id'], 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="manufacturersId[]" class="form-control">
                                ...
                                foreach($firms as $value=>$name) {
                                    if($regulator['manufacturersId'] == $value) {
