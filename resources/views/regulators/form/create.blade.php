...
@section('content')
    <div class="container">
        <div class="row">
            <div class="row">
                <a href="/regulators">РАСТЕЖНИ РЕГУЛАТОРИ</a>
            </div>
            <div class="col-lg-12">
                @if(count($errors)>0)
                ...
                @endif
                {!! Form::open(['url'=>'regulators/store', 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend>ДОБАВЯНЕ НА РАСТЕЖЕН РЕГУЛАТОР</legend>
