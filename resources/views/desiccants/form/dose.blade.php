    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @endif
                {!! Form::open(['url'=>'desiccants/dose_add/'.$desiccant->id , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend style="color: green">ДОБАВЯНЕ НА ДОЗИ КЪМ {{$desiccant->name}}</legend>
