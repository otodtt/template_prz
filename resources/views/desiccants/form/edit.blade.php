...
@section('content')
    <div class="container">
        <div class="row">
            <div class="row">
                <a href="{!!URL::to('/desiccants/'.$desiccants['id'])!!}" >НАЗАД</a>
            </div>
            <div class="col-lg-12">
                @if(count($errors)>0)
                ...
                @endif
                {!! Form::model($desiccants, ['url'=>'desiccants/update/'.$desiccants['id'], 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend>РЕДАКТИРАНЕ НА ДЕСИКАНТ</legend>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="manufacturersId[]" class="form-control">
                                ...
                                foreach($firms as $value=>$name) {
                                    if($desiccants['manufacturersId'] == $value) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="col-lg-12">
                                ...
                                {{--<label for="measure" class="control-label">Мерна Единица</label><br/>--}}
                                <?php
//                                var_dump($desiccants['measureId']);
                                if($desiccants['measureId'] == 0) {
                                    $value1 = '1, мл/дка';
                                    $value2 = '2, г/дка';
                                    $value3 = '3, %';
                                    $value4 = '4, л/дка';
