    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @endif
                {!! Form::model($dose[0], ['url'=>'desiccants/dose_update/'.$dose[0]['id'].'/'.$dose[0]['pesticides_id'] , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend style="color: green">РЕДАКТИРАНЕ НА ДОЗА КЪМ {{$desiccant->name}}</legend>
