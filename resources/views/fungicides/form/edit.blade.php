...
@section('content')
    <div class="container">
        <div class="row">
            <div class="row">
                <a href="{!!URL::to('/fungicides/'.$fungicide['id'])!!}" >НАЗАД</a>
            </div>
            <div class="col-lg-12">
                @if(count($errors)>0)
                ...
                @endif
                {!! Form::model($fungicide, ['url'=>'fungicides/update/'.$fungicide['id'], 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="manufacturersId[]" class="form-control">
                                ...
                                foreach($firms as $value=>$name) {
                                    if($fungicide['manufacturersId'] == $value) {
