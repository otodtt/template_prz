    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @endif
                {!! Form::model($subs, ['url'=>'fungicides/subs_update/'.$subs[0]['id'].'/'.$subs[0]['pesticides_id'] , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend style="color: blue">РЕДАКТИРАНЕ НА АКТИВНО ВЕЩЕСТВО КЪМ {{$fungicide->name}}</legend>
