    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @endif
                {!! Form::open(['url'=>'fungicides/subs_add/'.$fungicide->id , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend style="color: blue">ДОБАВЯНЕ НА АКТИВНО ВЕЩЕСТВО КЪМ {{$fungicide->name}}</legend>
