...
@section('content')
    <div class="container">
        ...
        <div class="row" style="text-align: center; color: green">
            <h4>ДОБАВЯНЕ НА ДОЗИ ЗА КУЛТУРИ ОТ ПРЗ  {{$fungicide->name}}</h4>
        </div>
        <div class="col-lg-12">
            @if(count($errors)>0)
            ...
            @endif
            {!! Form::open(['url'=>'fungicides/crop_dose_store/'.$fungicide->id.'/'.$doses[0]['id'] , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-lg-10 col-lg-offset-2">
                        <a href="{!!URL::to('/fungicides/'.$fungicide->id)!!}" class="btn btn-success">Назат</a>
