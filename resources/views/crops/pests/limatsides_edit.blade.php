    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @endif
                {!! Form::model($limatside, ['url'=>'crops/limatsides_update/'.$limatside->id , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend style="color: blue">РЕДАКТИРАНЕ НА ЛИМАЦИД ЗА {{$crops->name}}</legend>
