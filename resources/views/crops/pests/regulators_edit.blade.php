    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @endif
                {!! Form::model($regulator, ['url'=>'crops/regulators_update/'.$regulator->id , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend style="color: blue">РЕДАКТИРАНЕ НА РЕГУЛАТОР ЗА {{$crops->name}}</legend>
