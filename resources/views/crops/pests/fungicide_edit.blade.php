    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @endif
                {!! Form::model($fungicide, ['url'=>'crops/fungicides_update/'.$fungicide->id , 'method'=>'POST', 'id'=>'form', 'class'=>'form-horizontal']) !!}
                <fieldset>
                    <legend style="color: blue">РЕДАКТИРАНЕ НА ФУНГИЦИД ЗА {{$crops->name}}</legend>
