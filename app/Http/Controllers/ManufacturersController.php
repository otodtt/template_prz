...
class ManufacturersController extends Controller
{
    ...
    {
        $firms = Manufacturer::select('id', 'name', 'country')->where('id', $id)->with('Acaricides')->get()->toArray();
        $json = json_encode($firms, JSON_UNESCAPED_UNICODE);
//        dd($firms);

        return view('manufacturers.show', compact('firms'));
    }
